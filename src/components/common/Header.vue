    ...
    <div class="header">
        ...
        <div class="header-right">
          ...
          <div slot="footer" class="dialog-footer">
            <el-button @click="resetForm('pwdform')">重 置</el-button>
    ...
    methods: {
        ...
        submitPwd(formName) {
            this.$refs.pwdform.validate(valid => {
                if (valid) {
                    var param = {
                        mobile: localStorage.getItem('ms_username'),
                        oldPassword: Base64.encode(this.pwdform.oldpassword),
                        newPassword:Base64.encode(this.pwdform.password)
                    };
                    this.$http.post("/merchant/updatePwd", "application/json",param, res => {
                        if (res.data) {
